...
powerSim(model_best_simple , fixed("verbalIQ1:Visit"), nsim = 50, seed = 1, progress = F) # 100%
...
model_best_simple_ext <- extend(model_best_simple, along="Child.ID", n=300)
...
best_pc_interaction = powerCurve(model_best_simple_ext, fixed("verbalIQ1:Visit"), along = "Child.ID", nsim = 10, breaks = seq(from = 10, to = 300, by = 5), seed = 1, progress = F)
